...
class AgentTraceScreen extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                ...
                _buildActionCard(
                  ...
                  title: 'WHO Notified',
                  description:
                      'Alert dispatched to WHO and regional health authorities',
                  timestamp: 'Just now',
                  delayMs: 200,
                ),
                ...
                _buildActionCard(
                  ...
                  description:
                      'Travel advisory protocols initiated for the region',
                ...
                _buildActionCard(
                  ...
                  title: 'Labs Shared',
                  description:
                      'Sequence data shared with global research laboratories',
  ...
  Widget _buildActionCard({
    ...
    return Container(
        ...
        .slideX(begin: 0.1, delay: Duration(milliseconds: delayMs));
  }
}
